...
@interface TPCInterstitial()<TradPlusADInterstitialDelegate>

@property (nonatomic,strong)TradPlusAdInterstitial *interstitial;
@end

@implementation TPCInterstitial
...
- (void)showAdWithSceneId:(nullable NSString *)sceneId
{
    ...
    [self.interstitial showAdFromRootViewController:[TPCPluginUtil viewController] sceneId:sceneId];
}
...
{
    return [NSString stringWithFormat:@"window.TradPlusInterstitial.%@",event];
}

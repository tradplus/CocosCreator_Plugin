...
@interface TPCRewardVideo()<TradPlusADRewardedDelegate,TradPlusADRewardedPlayAgainDelegate>

@property (nonatomic,strong)TradPlusAdRewarded *rewarded;
@end

@implementation TPCRewardVideo
...
- (void)showAdWithSceneId:(nullable NSString *)sceneId
{
    ...
    [self.rewarded showAdFromRootViewController:[TPCPluginUtil viewController] sceneId:sceneId];
}
...
{
    return [NSString stringWithFormat:@"window.TradPlusRewardVideo.%@",event];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainImpression"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:nil];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainShowFailed"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:error];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainClicked"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:nil];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainRewarded"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:nil];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainPlayStart"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:nil];
}
...
{
    MSLogTrace(@"%s adInfo:%@", __PRETTY_FUNCTION__, adInfo);
    NSString *eventNam = [self eventName:@"playAgainPlayEnd"];
    [TradplusSdkPlugin callbackWithEventName:eventNam adUnitID:self.rewarded.unitID adInfo:adInfo error:nil];
}
@end
